...
public class TestLinAlg {
	...
	public static void main(String[] args) {
		try {
			...
			//System.out.println("myNewVector is: \n" + v1);
			...
			//m2.set(2, 1, 25);
			//m2.set(3, 2,2);
			//System.out.print("This is m2: \n" +m2);
			
			//Matrix m3 = new Matrix(5,2);
			//m3.set(row, col, val);
			
			//Matrix multiplyResult1 = Matrix.Multiply(m1,m2);
			//System.out.print("This is the matrix multiplication:\n" + multiplyResult1);
			...
			Vector v = new Vector("[ 1 2 3 4 5 ]");
			System.out.println("1. test constructor and toString(): " + v); // This automatically invokes v.toString()!
			System.out.println("2. test scalar addition: " + v.scalarAdd(1));//1 added to each vector, it only returns values, doesn't change the values of the vector itself
			System.out.println("3. ensure v was not modified: " + v); 
			v.scalarAddInPlace(2); 
			System.out.println("4. now v should be modified: " + v); // this adds value to vector and saves it as such 
			
			//test get:
			//double value = v.get(-4);
			//System.out.println("my test, this should give me something" +value  );
			...
			//test change dim
			//System.out.println("Test changing dimesnions");
			//v.changeDim(0);
			//System.out.println(v);
			
			//test multiplication in place that modifies v
			//v.scalarMultInPlace(2);
			//System.out.println("test scalar multiplication, should modify v: " + v);
			
			//test multiplication that doesn't change v 
			//Vector j = v.scalarMult(3);
			//System.out.println("test scalar multiplication, should NOT modify v: " + v);
			//System.out.println("test scalar multiplication, should resturn new vector : " + j);
			...
			//testing getNumCols 
			//System.out.println("number of rows in the matrix is " + n.getNumCols() );
			
			//test get for matrix ----STILL NEED TO TEST FOR FULL MATRIX DO NOT FORGET TO TEST 
			//System.out.println("the value at this place is " + n.get(-1,1));
			...
			//System.out.println("Testing get row \n" + n.getRow(1));
			
			//Matrix transpose = n.transpose();
			//System.out.print("Testing transpose of n \n" + transpose);
			
			//Testing transpose for matrix multiplication 
			...
			Matrix multiplied = Matrix.Multiply(n,t);
			System.out.print("multiplying n x t \n" + multiplied );
